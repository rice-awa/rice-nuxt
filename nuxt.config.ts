...
export default defineNuxtConfig({
	head: {
		...
		meta: [{ charset: "utf-8" }, { name: "viewport", content: "width=device-width, initial-scale=1" }, { hid: "description", name: "description", content: "全栈信息处理协会官网" }, { name: "keywords", content: "全栈信息处理, 协会, 全栈, 信息处理, 编程, 科技" }],
